...
plt.plot(fpr1, tpr1, marker='o', label='$F(W(x))$', color='slateblue')
fpr1m, tpr1m, _ = roc_curve(yt1m, ys1m, pos_label=1)
plt.plot(fpr1m, tpr1m, marker='.', label='$F(M(W(x)))$', color='crimson')
...
plt.plot(fpr2, tpr2, marker='o', label='$F(W(x))$', color='slateblue')
fpr2m, tpr2m, _ = roc_curve(yt2m, ys2m, pos_label=1)
plt.plot(fpr2m, tpr2m, marker='.', label='$F(M(W(x)))$', color='crimson')
plt.plot([0, 1], [0, 1], 'k:', label='_nolegend_')
...
plt.plot(fpr3, tpr3, marker='o', label='$F(W(x))$', color='slateblue')
fpr3m, tpr3m, _ = roc_curve(yt3m, ys3m, pos_label=1)
plt.plot(fpr3m, tpr3m, marker='.', label='$F(M(W(x)))$', color='crimson')
plt.plot([0, 1], [0, 1], 'k:', label='_nolegend_')
...
plt.plot(fpr4, tpr4, marker='o', label='$F(W(x))$', color='slateblue')
fpr4m, tpr4m, _ = roc_curve(yt4m, ys4m, pos_label=1)
plt.plot(fpr4m, tpr4m, marker='.', label='$F(M(W(x)))$', color='crimson', linewidth=3)
plt.plot([0, 1], [0, 1], 'k:', label='_nolegend_')
